...
const CustomerBilling: React.FC<CustomerBillingProps> = ({ darkMode }) => {
  ...
  const calculateBilling = () => {
    ...
    const newSubtotal = selectedServiceObjects.reduce(
    ...
    <div className="max-w-7xl mx-auto p-6 space-y-8 animate-fadeIn">
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className={cardClass + " p-8"}>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div
                className={`grid grid-cols-2 gap-3 max-h-52 overflow-y-auto border rounded-lg p-4 ${
                  darkMode
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setFormData((prev) => ({ ...prev, barberId: e.target.value }))
                }
                className={`${inputClass} ${
                  errors.barberId ? "border-red-500" : ""
                }`}
              >
                ...
                <div className="animate-slideIn">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`${inputClass} pl-10 ${
                        errors.membershipStartDate ? "border-red-500" : ""
                      }`}
                    />
                  </div>
                  ...
                  >
                    <input
                      ...
                      onChange={(e) =>
                        setFormData((prev) => ({
                          ...prev,
                          paymentMode: e.target.value as "Cash" | "Paytm",
                        }))
                      }
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData((prev) => ({
                    ...prev,
                    manualAdjustment: Number(e.target.value),
                  }))
                }
                className={inputClass}
                placeholder="0"
            ...
            {subtotal > 0 && (
              <div
                className={`rounded-lg p-4 space-y-2 border animate-slideIn ${
                  darkMode
                    ? "bg-gray-700/50 border-gray-600"
                    : "bg-gray-50 border-gray-200"
                }`}
              >
                ...
                {formData.manualAdjustment !== 0 && (
                  ...
                  >
                    ...
                    <span className="font-semibold">
                      {formData.manualAdjustment > 0 ? "+" : ""}
                      {formatCurrency(formData.manualAdjustment)}
                    </span>
                  </div>
                )}
                <hr
        ...
        <div className={cardClass + " p-8 h-fit"}>
          ...
          <div
            className={`space-y-4 ${
              transactions.length > 6 ? "max-h-96 overflow-y-auto" : ""
            }`}
          >
